...
Status: Phases 0 to 3 done 2026-09-03 (see `docs/eval/FIXTURE.md`). Phase 3 winner: RealVisXL V5
+ DMD2 4-step LoRA as a two-node chain (stage 1 cn 0.3, refine cn 0.85 dn 0.65), about 8x the
Turbo chain's sharpness at the same step time. Phase 4 (FP8) not started.
