...
cd /d %B%
call :one realvis_768x448 768 448
call :one realvis_704x384 704 384
echo SMALL_ALL_DONE
exit /b 0
:one
set NAME=%1
...
%PY% -u %EXP%\export_fused_unet.py --base-unet weights\realvisxl-v5\unet --variant fp16 --lora weights\dmd2\dmd2_sdxl_4step_lora_fp16.safetensors --lora-scale 1.0 --width %W% --height %H% --out onnx\%NAME%\fused.onnx > logs\export_%NAME%.log 2>&1
